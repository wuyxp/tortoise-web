...
1. **本地优先**: 你和孩子使用小龟时光的几乎所有数据 (使用时长、限额配置、亲子 PIN、探险币、图鉴解锁等) **完全存储在你的设备上**, 不上传到任何服务器。**唯一例外**是崩溃日志与匿名化分析事件 — 它们经假名化处理后传给 Google Firebase (详见 §3.2), 不含任何能识别你或孩子身份的信息
...
| **删除权** | 设置 → 关于小龟时光 → 清空所有数据 (30 秒长按确认) 或 卸载 App |
